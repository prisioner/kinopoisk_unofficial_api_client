...
RSpec.describe KinopoiskUnofficialApiClient::Exceptions::ResponseError, :vcr do
  subject(:error) do
  ...
  let(:response) { KinopoiskUnofficialApiClient::Client.new("WRONG-API-KEY").call(method_name) }
