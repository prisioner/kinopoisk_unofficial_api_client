...
RSpec.describe KinopoiskUnofficialApiClient::RequestSchemas do
  KinopoiskUnofficialApiClient::ENDPOINTS.each do |method_name, endpoint_params|
    schema_file_short_path = "lib/kinopoisk_unofficial_api_client/request_schemas/#{method_name}.rb"
